...
if [ -z "$MORDOR_DATASETS" ]; then
  ...
  usage
    ...
    wget -O /opt/logstash/pipeline/json-file-input.conf https://raw.githubusercontent.com/Cl0ud-Sm3gaL/azure-range/main/grocery-list/custom-log-pipeline/logstash/pipeline/json-file-input.conf
